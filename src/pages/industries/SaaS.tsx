          ...
          <div className="max-w-7xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
              <div className="inline-flex items-center gap-2 bg-blue-500/10 backdrop-blur-sm border border-blue-400/20 rounded-full px-6 py-3 mb-8">
                ...
                <span className="text-sm font-medium text-blue-700">SaaS Cybersecurity</span>
              </div>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Link to="/contact" className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-gray-900 px-8 py-4 rounded-full font-semibold shadow-lg shadow-blue-500/50 transition-all">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <motion.div key={index} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.1 }} className="bg-white/5 backdrop-blur-xl border border-gray-200 rounded-2xl p-8 hover:bg-white/10 hover:border-blue-400/30 transition-all">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {challenge.risks.map((risk, i) => (
                      <span key={i} className="px-3 py-1 bg-blue-500/20 border border-blue-400/30 rounded-full text-xs text-blue-700">{risk}</span>
                    ))}
                  </div>
                </motion.div>
              ))}
        ...
        <div className="w-full px-6 lg:px-12">
          <div className="max-w-7xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
              ...
              <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mt-4">SaaS Security Services</h2>
            </motion.div>
        ...
        <div className="w-full px-6 lg:px-12">
          <div className="max-w-5xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="bg-gradient-to-r from-blue-500/20 via-cyan-500/20 to-indigo-500/20 backdrop-blur-xl border border-blue-400/30 rounded-3xl p-12 text-center">
              <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 mb-6">Secure Your SaaS Platform</h2>
