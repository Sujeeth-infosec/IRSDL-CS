    ...
    <div className="relative min-h-screen">
      ...
      <section className="relative w-full pt-32 pb-20">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src="https://images.unsplash.com/photo-1565043589221-1a6fd9ae45c7?auto=format&fit=crop&w=2000&q=80" 
          ...
          <div className="max-w-7xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
              <div className="inline-flex items-center gap-2 bg-orange-500/10 backdrop-blur-sm border border-orange-400/20 rounded-full px-6 py-3 mb-8">
                ...
                <span className="text-sm font-medium text-orange-700">Manufacturing Cybersecurity</span>
              </div>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Link to="/contact" className="inline-flex items-center gap-2 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-gray-900 px-8 py-4 rounded-full font-semibold shadow-lg shadow-orange-500/50 transition-all">
                  Schedule Assessment <ArrowRight className="w-5 h-5" />
                </Link>
                <Link to="/services" className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm hover:bg-white/20 text-gray-900 border border-white/20 px-8 py-4 rounded-full font-semibold transition-all">
                  View Services
                </Link>
              </div>
            </motion.div>
        ...
        <div className="w-full px-6 lg:px-12">
          <div className="max-w-7xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
              ...
              <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mt-4">Critical Security Challenges</h2>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <motion.div key={index} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.1 }} className="bg-white/5 backdrop-blur-xl border border-gray-200 rounded-2xl p-8 hover:bg-white/10 hover:border-orange-400/30 transition-all">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {challenge.risks.map((risk, i) => (
                      <span key={i} className="px-3 py-1 bg-orange-500/20 border border-orange-400/30 rounded-full text-xs text-orange-700">{risk}</span>
                    ))}
                  </div>
                </motion.div>
              ))}
        ...
        <div className="w-full px-6 lg:px-12">
          <div className="max-w-7xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
              ...
              <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mt-4">Manufacturing Security Services</h2>
            </motion.div>
        ...
        <div className="w-full px-6 lg:px-12">
          <div className="max-w-5xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="bg-gradient-to-r from-orange-500/20 via-amber-500/20 to-yellow-500/20 backdrop-blur-xl border border-orange-400/30 rounded-3xl p-12 text-center">
              <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 mb-6">Secure Your Manufacturing Operations</h2>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                ...
                <a href="tel:+919493782350" className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm hover:bg-white/20 text-gray-900 border border-white/20 px-8 py-4 rounded-full font-semibold transition-all">
                  Call: +91 94937 82350
                </a>
              </div>
            </motion.div>
