    ...
    <div className="relative min-h-screen">
      ...
      <section className="relative w-full pt-32 pb-20">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src="https://images.unsplash.com/photo-1555374018-13a8994ab246?auto=format&fit=crop&w=2000&q=80" 
          ...
          <div className="max-w-7xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Link to="/contact" className="inline-flex items-center gap-2 bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-gray-900 px-8 py-4 rounded-full font-semibold shadow-lg shadow-indigo-500/50 transition-all">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <motion.div key={index} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.1 }} className="bg-white/5 backdrop-blur-xl border border-gray-200 rounded-2xl p-8 hover:bg-white/10 hover:border-indigo-400/30 transition-all">
        ...
        <div className="w-full px-6 lg:px-12">
          <div className="max-w-7xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
              ...
              <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mt-4">Government Security Services</h2>
            </motion.div>
        ...
        <div className="w-full px-6 lg:px-12">
          <div className="max-w-5xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="bg-gradient-to-r from-indigo-500/20 via-purple-500/20 to-pink-500/20 backdrop-blur-xl border border-indigo-400/30 rounded-3xl p-12 text-center">
              <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 mb-6">Secure Your Government Systems</h2>
