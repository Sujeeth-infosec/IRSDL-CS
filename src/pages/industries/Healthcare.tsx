          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              <div className="inline-flex items-center gap-2 bg-red-500/10 backdrop-blur-sm border border-red-400/20 rounded-full px-6 py-3 mb-8">
                ...
                <span className="text-sm font-medium text-red-300">Healthcare Cybersecurity</span>
              </div>
              ...
              <p className="text-xl text-gray-400 mb-12 max-w-3xl mx-auto leading-relaxed">
                HIPAA-compliant security testing for hospitals, clinics, and healthcare technology providers. 
                Protect patient data and ensure regulatory compliance with specialized healthcare security expertise.
              </p>

              <div className="flex flex-wrap justify-center gap-4">
                <Link
                  to="/contact"
                  className="inline-flex items-center gap-2 bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 text-white px-8 py-4 rounded-full font-semibold shadow-lg shadow-red-500/50 transition-all"
                >
                  Schedule Assessment
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {challenges.map((challenge, index) => (
                <motion.div
                  ...
                  className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 hover:bg-white/10 hover:border-red-400/30 transition-all"
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {challenge.risks.map((risk, i) => (
                        <span
                          key={i}
                          className="px-3 py-1 bg-red-500/20 border border-red-400/30 rounded-full text-xs text-red-300"
                        >
                          {risk}
                        </span>
                      ))}
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {compliance.map((item, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: index * 0.1 }}
                  className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 text-center hover:bg-white/10 hover:border-red-400/30 transition-all"
                >
